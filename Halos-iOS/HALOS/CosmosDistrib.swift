...
//  HALOS
//
//  Created by Brice Buccolo on 3/7/17.
...
//
//
//This file was taken directly from the github link above. It has been slightly modified to
//fit the HALOS project. The only use for this file was to make the stars editable to display
//the user and tour ratings.
//
